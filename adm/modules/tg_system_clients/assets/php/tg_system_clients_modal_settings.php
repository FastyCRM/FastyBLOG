<?php
/**
 * FILE: /adm/modules/tg_system_clients/assets/php/tg_system_clients_modal_settings.php
 * ROLE: modal_settings — модалка настроек Telegram-бота клиентов
 */
...
$defaultWebhook = ($host !== '')
  ? ($scheme . '://' . $host . url('/core/telegram_webhook_system_clients.php'))
  : url('/core/telegram_webhook_system_clients.php');

ob_start();
?>
<form method="post" action="<?= h(url('/adm/index.php?m=tg_system_clients&do=settings_update')) ?>" class="form">
  <input type="hidden" name="csrf" value="<?= h($csrf) ?>">

  <div class="card" style="box-shadow:none; border-color:var(--border-soft);">
    <div class="card__head">
      <div class="card__title">Настройки Telegram-бота клиентов</div>
    ...
    <div class="card__body" style="display:grid; gap:12px;">
      <label class="field" style="display:flex; align-items:center; gap:8px;">
        ...
        <span>Включить Telegram-уведомления клиентам</span>
      </label>
...
json_ok([
  'title' => 'Настройки TG-бота клиентов',
  'html' => $html,
]);