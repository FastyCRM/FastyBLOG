...
return [
  ...
  'promobot.col_promo_source' => 'Promo source',
  ...
  'promobot.channels_probe_hint_tg' => 'Telegram: loads known chats from bot logs and current bindings. For completely new chats without incoming events, use bind code.',
  'promobot.channels_probe_hint_max' => 'MAX: loads available bot chats from API and lets you add them in one click.',
  'promobot.channels_probe_idle' => 'Click \"Find chats\" to load the list.',
  'promobot.channels_probe_loading' => 'Loading chats list...',
  'promobot.action_channel_probe' => 'Find chats',
  'promobot.action_channel_add' => 'Add',
  'promobot.channels_probe_added' => 'Already added',
  ...
  'promobot.promos_shared_hint' => 'Shared promo list from bot: {bot}.',
  ...
  'promobot.action_max_webhook_info' => 'Check MAX webhook',
  'promobot.action_max_webhook_set' => 'Set MAX webhook',
  ...
  'promobot.field_promo_source_bot' => 'Promo list source',
  'promobot.promo_source_self' => 'Own list (no shared source)',
  ...
  'promobot.flash_max_webhook_set_ok' => 'MAX webhook set.',
  'promobot.flash_max_webhook_set_fail' => 'Failed to set MAX webhook: {error}',
  'promobot.flash_max_webhook_info_ok' => 'MAX webhook is active and receives events.',
  'promobot.flash_max_webhook_info_fail' => 'MAX webhook is not active: {error}',
  'promobot.flash_promo_source_not_found' => 'Promo source bot not found.',
  'promobot.flash_promo_source_cycle' => 'Cyclic promo source links are not allowed.',
  ...
  'promobot.flash_channel_added' => 'Chat added.',
  'promobot.flash_channel_add_fail' => 'Failed to add chat: {error}',
