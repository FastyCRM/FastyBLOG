...
CREATE TABLE IF NOT EXISTS `stopbot_settings` (
  `id` TINYINT UNSIGNED NOT NULL,
  `log_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `stop_words_list` MEDIUMTEXT NOT NULL,
  `stop_domains_list` MEDIUMTEXT NOT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE IF NOT EXISTS `stopbot_bots` (
...
CREATE TABLE IF NOT EXISTS `stopbot_channels` (
...
CREATE TABLE IF NOT EXISTS `stopbot_user_access` (
...
CREATE TABLE IF NOT EXISTS `stopbot_bind_tokens` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `bot_id` INT UNSIGNED NOT NULL,
  `platform` ENUM('tg','max') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `stopbot_logs` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `bot_id` INT UNSIGNED NOT NULL,
  `platform` ENUM('tg','max') NOT NULL,
...
INSERT INTO `stopbot_settings`
(`id`, `log_enabled`, `stop_words_list`, `stop_domains_list`)
VALUES (1, 1, '', '')
