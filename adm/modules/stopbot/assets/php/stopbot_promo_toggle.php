<?php
/**
 * FILE: /adm/modules/stopbot/assets/php/stopbot_promo_toggle.php
...
audit_log(STOPBOT_MODULE_CODE, 'promo_toggle', 'info', [
  'promo_id' => $promoId,
  'bot_id' => $botId,
...
flash($enabled ? stopbot_t('stopbot.flash_promo_enabled') : stopbot_t('stopbot.flash_promo_disabled'), 'ok');
