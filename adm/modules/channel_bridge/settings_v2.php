...
const CHANNEL_BRIDGE_MEDIA_GROUP_MIN_ITEMS = 2;
const CHANNEL_BRIDGE_MEDIA_GROUP_DISPATCH_STALE_SECONDS = 30;
const CHANNEL_BRIDGE_JOBS_ALBUM_WAIT_SECOND_MS = 30000;
const CHANNEL_BRIDGE_JOBS_ALBUM_QUIET_AFTER_SECOND_MS = 20000;
const CHANNEL_BRIDGE_JOBS_ALBUM_POLL_SECONDS = 2;
const CHANNEL_BRIDGE_JOBS_ALBUM_MAX_WAIT_MS = 60000;
