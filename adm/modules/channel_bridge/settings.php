...
const CHANNEL_BRIDGE_MEDIA_GROUP_WAIT_MAX_MS = 120000;
const CHANNEL_BRIDGE_MEDIA_GROUP_WAIT_STEP_MS = 100;
const CHANNEL_BRIDGE_MEDIA_GROUP_QUIET_MS = 25000;
...
const CHANNEL_BRIDGE_MEDIA_GROUP_RETRY_COOLDOWN_SECONDS = 15;
const CHANNEL_BRIDGE_MEDIA_GROUP_MAX_RETRIES = 3;
const CHANNEL_BRIDGE_MEDIA_GROUP_ACTIVE_WINDOW_SECONDS = 1800;
const CHANNEL_BRIDGE_MEDIA_GROUP_ABANDON_AFTER_SECONDS = 1800;
const CHANNEL_BRIDGE_MEDIA_GROUP_SWEEP_MAX_SECONDS = 120;
const CHANNEL_BRIDGE_MEDIA_GROUP_SWEEP_STEP_MS = 5000;
const CHANNEL_BRIDGE_MEDIA_GROUP_SWEEP_BATCH = 5;
