<?php
/**
 * FILE: /adm/modules/ym_link_bot/webhook.php
 * ROLE: Dedicated webhook listener for this module copy.
 */
...
try {
  ...
  audit_log(ymlb_module_code(), 'webhook', 'info', [
    'reason' => (string)($result['reason'] ?? ''),
  ...
  audit_log(ymlb_module_code(), 'webhook', 'error', [
    'error' => $e->getMessage(),
  ]);
